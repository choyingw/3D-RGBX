...
cfg.DATASET.TRAIN_NPZ_ROOT = f"data/megadepth/index/scene_info_0.1_0.7_no_sfm"
cfg.DATASET.TRAIN_LIST_PATH = f"data/megadepth/index/trainvaltest_list/train_list.txt"
...
cfg.DATASET.VAL_NPZ_ROOT = cfg.DATASET.TEST_NPZ_ROOT = f"data/megadepth/index/scene_info_val_1500_no_sfm"
cfg.DATASET.VAL_LIST_PATH = cfg.DATASET.TEST_LIST_PATH = f"data/megadepth/index/trainvaltest_list/val_list.txt"
